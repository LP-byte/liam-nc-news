function singleDateFormat (article) {
    ...
    for (let property in  article){
        ...
        if (secondsPast < 61){
         ...
         console.log(parseInt(secondsPast))
        }
        ...
        const articleWithDateFormatted = {...article, created_at: articlePostTime}
      
        return articleWithDateFormatted
      }
        
    }


export default singleDateFormat;